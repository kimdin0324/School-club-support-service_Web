        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>진로 동아리<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <%--##########################################################################################--%>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="백향목.jsp">백향목</a></h3>
          		</div>
              <a href="백향목.jsp" class="block-20" style="background-image: url('images/백향목.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>기독교를 믿거나, 관련 진로를 꿈꾸는 학생들이 함께 비전을 키우는 동아리입니다.</p>
                <p><a href="백향목.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="유네스코.jsp">유네스코</a></h3>
          		</div>
              <a href="유네스코.jsp" class="block-20" style="background-image: url('images/유네스코.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>지역사회의 구성원들에게 국제적인 관심을 촉구하고 탐구를 진행하는 동아리입니다</p>
                <p><a href="유네스코.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="Makesense.jsp">Makesense</a></h3>
          		</div>
              <a href="Makesense.jsp" class="block-20" style="background-image: url('images/make.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>패션을 주제로 활동하는 동아리입니다.<br><br><br></p>
                <p><a href="Makesense.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
