        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>체육 동아리<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <%--##########################################################################################--%>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="팬텀.jsp">팬텀</a></h3>
          		</div>
              <a href="팬텀.jsp" class="block-20" style="background-image: url('images/팬텀.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>농구 초보자도 들어올 수 있고 함께 웃으면서 즐겁게 합시다.</p>
                <p><a href="팬텀.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="자율야구.jsp">자율야구부</a></h3>
          		</div>
              <a href="자율야구.jsp" class="block-20" style="background-image: url('images/자율야구부.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>야구에 관심이 있는 학생들 있는 학생들이 모인 동아리입니다.</p>
                <p><a href="자율야구.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="복4중창단.jsp">싸이클론</a></h3>
          		</div>
              <a href="싸이클론.jsp" class="block-20" style="background-image: url('images/싸이클론.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>실력은 필요 없어! 열정과 관심만 있으면 돼<br><br></p>
                <p><a href="싸이클론.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
