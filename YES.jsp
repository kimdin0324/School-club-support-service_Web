	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="practice-areas.jsp" class="nav-link">동아리 살펴보기</a></li>
...
<!-- ######################################################### -->
     <h1 class="mb-3 bread">Y.E.S (Young Economic Soul) </h1>
<!-- ######################################################### -->



            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 



<!-- ######################################################### -->
    <span>Y.E.S <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                         상경계열 진학을 목표로 하는 학생들이 모인 경제·경영 동아리. 경제 시사에 대한 탐구와 경제이론, 주요 기업의 경영전략, 실물경제 관련 지표 등 경제·경영과 관련된 여러 지식 함양을 목표로 하는 동아리임. 
                        경제포럼, 자산운용시뮬레이션, 청주시내고교연합동아리 등 경제·경영 관련 행사를 주최해 이론적 내용을 실물 경제에 적용함으로써 동아리 구성원들의 경제적 지식 함양을 위한 활동을 해왔음. 앞으로도 다채로운 활동을 할 예정임. <br>
                         <br>
                         <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           6명(추후 변경 될 수 있음)<br></p>
           <p>------------------------------------------------------</p>
            <p><b>></b> <b>선발기준</b><br>
                          ● 선발기준: 상경계열 진학을 희망하는 학생 중 경제 시사에 관심이 많으며 경제 현상 탐구에 열정이 있는 학생.<br>
                          ● 선발 방법: 면접을 통한 평가</p>
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                                   ● 신문 스크랩 후 시사 비판 활동<br>
                                   ● 경제 시사 탐구 후 하브루타 파트너와 토론<br>
                                   ● 주요 기업 경영전략 분석<br>
                                   ● 실물경제 체험 활동(기관 탐방)<br>
                                   ● 신흥 경제 포럼 개최<br>
                                   ● 자산운용 시뮬레이션 개최<br>
<br>
                                                                                                                              ※코로나19로 인해 추후 변경 가능성 있음.<br>
                                    (주요 활동만 기입했으며 이외에도 다수 활동을 할 예정임.)<br> </p>
            <p></p>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/신문.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>신문 스크랩</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
                </div>
              </div>
            </div>
             <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/토론.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>경제토론</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/기업.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>기업 경영전략 분석</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/기관.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>기관 탐방</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/포럼.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a> 경제 포럼 개최</a></h3>
                  <div class="meta">                    
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/자산.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>자산운용 시뮬레이션</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 1년 내내</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <h3>Unknown knowledge</h3>
              <div class="tagcloud">
                <a class="tag-cloud-link">경제</a>
                 <a class="tag-cloud-link">기업운영</a>
                <a class="tag-cloud-link">상경계열</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li class="active"><a href="YES.jsp">Y.E.S<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
