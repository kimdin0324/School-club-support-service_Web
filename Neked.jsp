...
<!-- ######################################################### -->
     <h1 class="mb-3 bread">Neked lamb</h1>
<!-- ######################################################### -->
...
<!-- ######################################################### -->
    <span>Neked lamb <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                      신흥고 최고의 음악동아리 Neked lamb입니다. 교내외 활동 뿐만 아니라 사운드클라우드 등의 언더그라운드 음원사이트나 유튜브를 통해 활동예정입니다.
                      큐베이스, FLstdio 등의 시퀀서(작곡프로그램)을 배울수 있고 이외에도 보컬 이론 등의 스터디를 통해 음악적 지식을 키울수있습니다.
                      앞서 소개한 시퀀서를 통해 직접 작곡,작사,편곡하여 정기적으로 노래를 만들 예정입니다. 
                      축제기간에는 본교 축제만이 아닌 여고 등으로 찬조공연을 갈 예정이기에 무대매너와 제스쳐 등의 무대 테크닉도 또한 기를 수 있고,
                      음악 쪽에 진로를 거졌다면 저희 동아리만큼 경험과 배움면에서 뛰어난 동아리는 없을것입니다.  <br> 
                   <br>   
                      진로가 아니라해도 환영합니다.  <br> 
                      마이크와 믹서,마스터키보드 등의 장비가 구비되어 있습니다. <br> 
             1학년 부원은 더욱 환영합니다.<br><br>         
            <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           10명(보컬,랩,미디작곡) <br> 
                                                                                               ※ 보컬은 2명 한정 ※<br></p>
           <p>------------------------------------------------------</p>
            <p><b>></b> <b>선발기준</b><br>
                          시기가 시기인만큼 영상이나 메신저를 이용해서 심사합니다.<br> 
                          보컬,랩 - 신청후 안내되는 연락처로 영상 전송<br> 
                          미디 - 신청후 안내되는 연락처로 영상 전송</p>
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                               1. 큐베이스 등의 시뭔서,보컬,이론,랩 스터디 활동<br> 
                               2. 작곡,편곡,녹음 or 기존곡 커버 or 기존음악 2차 창작<br> 
                               3. 축제기간에 본교공연 및 찬조공연<br>
                               4. 각종 장비로 비트메이킹, 작곡<br> 
                               5. 리스닝을 위해 음악적 파노라마 확장을 목표로 각자 마이너한 노래 추천</p>
            <p></p>     
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">힙합</a>
                 <a class="tag-cloud-link">RnB</a>
                <a class="tag-cloud-link">시퀀서</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
               <li><a href="RAIN.jsp">Rain<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="Neked.jsp">Neked lamb<span class="ion-ios-arrow-forward"></span></a></li>
                <li class="active"><a href="복4중창.jsp">복4중창단<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
