        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>추후모집<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <%--##########################################################################################--%>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">C.T.S</a></h3>
          		</div>
               <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>추후 모집 예정의 동아리입니다.<br><br> </p>
                <p><a href="ErrAction.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">그날,독도가 내게로</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">대중음악 힙합동아리</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">도전자취요리</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">몰딩</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">서로작</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="ErrAction.jsp">항공과학동아리</a></h3>
          		</div>
              <a href="ErrAction.jsp" class="block-20" style="background-image: url('images/미지원.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
