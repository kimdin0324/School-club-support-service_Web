	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="blog.jsp" class="nav-link">생기부 상세설명</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">생기부 상세설명</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span>생기부 상세설명<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <%--1  ##########################################################################################--%>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">                          
          			<h3 class="heading mb-0"><a href="blog-single.jsp">CA와 자율의 차이점은 과연 무엇일까</a></h3>
          		</div>
              <a href="blog-single.jsp" class="block-20" style="background-image: url('http://dong0324.cdn3.cafe24.com/a2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center">
              		<div class="one py-2 pl-3 pr-1 align-self-stretch">
              		<span class="mos"><b>| 작성  |</b></span>
              			<span class="mos">고동현</span>
              		</div>
              		<div class="two pl-0 pr-3 py-2 align-self-stretch">
              			<span class="yr">2학년 4반</span>
              			<span class="mos">네뷸라 부장</span>
              		</div>
              	</div>
                <p>동아리 운영 방식과 <br>생기부에 들어가는 <br>글자 수의 차이.</p>
                <p><a href="blog-single.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">                            
          			<h3 class="heading mb-0"><a href="blog-single2.jsp">동아리는 진로와 관련이 있어야 하나?</a></h3>
          		</div>
              <a href="blog-single2.jsp" class="block-20" style="background-image: url('http://dong0324.cdn3.cafe24.com/b2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center">
              		<div class="one py-2 pl-3 pr-1 align-self-stretch">
                ...
                <p>맞게 활동하는것이<br>좋지만 동아리보단 <br>활동과 의미가 중요</p>
                <p><a href="blog-single2.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">                                                     
          			<h3 class="heading mb-0"><a href="blog-single3.jsp">생기부 활동과 희망 전공의 연관성은?</a></h3>
          		</div>
              <a href="blog-single3.jsp" class="block-20" style="background-image: url('http://dong0324.cdn3.cafe24.com/c2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center">
              		<div class="one py-2 pl-3 pr-1 align-self-stretch">
              		<span class="mos"><b>| 작성  |</b></span>
              			<span class="mos">김영빈</span>
              		</div>
              		<div class="two pl-0 pr-3 py-2 align-self-stretch">
              			<span class="yr">2학년 6반</span>
              			<span class="mos">네뷸라 차장</span>
              		</div>
              	</div>
                <p>스토리 있는 생기부<br>나의 전공적합성? <br>도움이 되는 정보</p>
                <p><a href="blog-single3.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
        ...
        <%-- 4  ##########################################################################################--%>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">                                                  
          			<h3 class="heading mb-0"><a href="blog-single4.jsp">자율동아리 활용방법은 무엇인가요?</a></h3>
          		</div>
              <a href="blog-single4.jsp" class="block-20" style="background-image: url('http://dong0324.cdn3.cafe24.com/d2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center">
              		<div class="one py-2 pl-3 pr-1 align-self-stretch">
              		<span class="mos"><b>| 작성  |</b></span>
              			<span class="mos">김재용</span>
              		</div>
              		<div class="two pl-0 pr-3 py-2 align-self-stretch">
              			<span class="yr">2학년 4반</span>
              			<span class="mos">네뷸라 차장</span>
                ...
                <p>CA만 중요하다?<br>자율 동아리 활용법<br>슬기로운 생기부 관리</p>
                <p><a href="blog-single4.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">                                          
          			<h3 class="heading mb-0"><a href="blog-single5.jsp">학종시대의 전략적인 생기부 관리법!</a></h3>
          		</div>
              <a href="blog-single5.jsp" class="block-20" style="background-image: url('http://dong0324.cdn3.cafe24.com/e2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center">
              		<div class="one py-2 pl-3 pr-1 align-self-stretch">
                ...
                <p>대입에서 중요한 독서<br>바람직한 독서 계획?<br>꼼꼼히 챙기는 수시 </p>
                <p><a href="blog-single5.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
