        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>경제 동아리<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="YES.jsp">Y.E.S</a></h3>
          		</div>
              <a href="YES.jsp" class="block-20" style="background-image: url('images/yes.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                 <p> 2019년 동아리보고대회 대상 동아리로, 상경계열 진로를 희망하는 학생이라면 필수적으로 가입해야 하는 동아리.</p>
                <p><a href="YES.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
