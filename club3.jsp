    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('http://dong0324.cdn3.cafe24.com/bg_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
          <%--##########################################################################################--%>
            <h1 class="mb-3 bread">공학/과학 동아리</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기<i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>공학/과학 동아리<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="NPC.jsp">NPC</a></h3>
          		</div>
              <a href="NPC.jsp" class="block-20" style="background-image: url('images/NPC.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>충북 최고수준의 활동과 장비,예산은 물론 자문을 얻을 수 있는 외부 커넥션까지 제공하는 NPC입니다</p>
                <p><a href="NPC.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
