...
<!-- ######################################################### -->
    <span>팬텀 <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                      농구를 통해서 기초 체력을 기르고 친구들이나 부원들과 협력하여 함께 농구를 즐길 수 있고 경기를 통해서 승부욕과 경쟁심을 늘릴 수 있습니다. 
                      경기를 통해서 꾸준한 실력향상과 팀원들과 협동심을 길러 나갈 것입니다. 실력이 향상되어 기회가 된다면 대회에도 나가는 것을 목표로 할 것입니다. 
                      또 초보자도 함께 들어와 농구를 차근차근 배워가면서 즐겁게 농구를 할 수 있게 만들겠습니다.
                         <br><br>
                         <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                                      3~10명<br></p>
           <p>------------------------------------------------------</p>
            <p><b>></b> <b>선발기준</b><br>
                                           기초 능력 확인 및 몇가지 질문을 통해서 면접형식으로 뽑겠습니다. <br>활동에 적극적으로 참여할 인원을 뽑습니다.</p>
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                                      농구 슛 or 패스 or 드리블 연습 및 1대1 경기나 3점슛 대결 등을 하여 즐겁게 농구를 할 수 있게 할 것입니다. 그리고 기회가 되면 대회에도 나가 서로의 관계를 키워나가겠습니다.
...
<br> </p>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
           ...
           <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">농구</a>
                 <a class="tag-cloud-link">드리블</a>
                 <a class="tag-cloud-link">슛</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li class="active"><a href="팬텀.jsp">팬텀<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="자율야구부.jsp">자율야구부<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="싸이클론.jsp">싸이클론<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
