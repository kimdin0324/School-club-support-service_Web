...
<!-- ######################################################### -->
    <span>이그노벨 <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                        실생활 속에서 호기심을 자극하는 소재들에 대해 깊이있게 탐구해보는 활동을 하는 실생활 속에 발생하는 현상 탐구 문이과 융합 동아리입니다.<br>
                         <br>
                         <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           5명<br></p>
           <p>------------------------------------------------------</p>
            ...
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                        7월 : 실생활 속 동아리 공통 주제탐구 <br>
                        8월 : 개별 주제탐구<br>
                        9월 : 학술발표회 (공통,개인 주제발표)<br>
                        10월 : 실생활 속 동아리 공통주제 탐구<br>
                        11월 : 개별 주제탐구<br>
                        12월 : 활동정리 및 학술 발표회<br>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/주제.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>공통 주제탐구</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 7월,10월 </a></div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/개인.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>개별 주제탐구</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 8월,11월</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
                </div>
              </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/발표.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>학술발표회</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 9월,12월</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
                </div>
              </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">문이과 융합</a>
                 <a class="tag-cloud-link">주제탐구</a>
                <a class="tag-cloud-link">학술</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li class="active"><a href="이그노벨.jsp">이그노벨<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
