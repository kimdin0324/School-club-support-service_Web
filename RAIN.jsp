...
<!-- ######################################################### -->
    <span>Rain <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                       음악 분야중에서도 어쿠스틱을 기반으로 한 분위기의 곡을 선호하는 <br>학생들이 모여 같이 합을 맞춰 공연하는 밴드부입니다.<br><br>         
            <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           5명<br></p>
           <p>------------------------------------------------------</p>
            <p><b>></b> <b>선발기준</b><br>
                          선발기준 : 음악을 좋아하면서 음악적 감각이 뛰어남<br>
                          선발방법 : 오디션을 통하여 선발</p>
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                               달마다 열리는 학교 내 음악관련 행사나, 축제 또는 학교 외부 행사에<br> 다같이 참여하여 활동할 수 있도록 노력할 것입니다.</p>
            <p></p>     
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">밴드음악</a>
                 <a class="tag-cloud-link">음악</a>
                <a class="tag-cloud-link">어쿠스틱</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
               <li class="active"><a href="RAIN.jsp">Rain<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="Neked.jsp">Neked lamb<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="복4중창.jsp">복4중창단<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
