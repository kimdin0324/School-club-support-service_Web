...
<!-- ######################################################### -->
    <span>백향목 <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                       위 동아리는 기독교 신앙을 가지고, 삶에서 빛과 소금으로 살아가기 위해서 말씀과 기도로 무장하고, 백향목과 같이 성전에 귀하게 사용되는 학생들이 되기 위해 함께 모이는 곳이며 기독교를 믿거나, 관련 진로를 꿈꾸는 학생들이 함께 비전을 키우는 동아리입니다. <br>
                         <br>
                         <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                                            무제한<br></p>
...
<br> </p>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
           ...
           <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">기독교</a>
                 <a class="tag-cloud-link">백향목</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li class="active"><a href="백향목.jsp">백향목<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="유네스코.jsp">유네스코<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="Makesense.jsp">Makesense<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
