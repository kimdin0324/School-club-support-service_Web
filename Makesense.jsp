...
<!-- ######################################################### -->
     <h1 class="mb-3 bread">Makesense </h1>
<!-- ######################################################### -->
...
<!-- ######################################################### -->
    <span>Makesense <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                       이 동아리는 패션에 관심에 관심있는 친구들이 함께 모여 패션에 대해 더 많은 지식을 지식을 쌓고 평소 쉽게 할 수 없던 패션관련 활동을 하는 동아리이다.<br><br>         
            <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           5명<br></p>
           <p>------------------------------------------------------</p>
            ...
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                        패션관련 영상 시청 후 트랜드 조사, 자신이 가장 자신있는 패션 스타일에 대해 공부를 한후 동묘를 찾아가 어떻게 입어야할지 생각을 한후 코디를 하고,
                        가을 패션워크 시즌에는 ddp에 방문하여 많은 모델들의 패션을 분석하고, 많은 활동을 하며 배운것과 찍은 사지을 이용해 패션 잡지를 만들어볼 생각이다</p>
            <p></p>     
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">패션</a>
                 <a class="tag-cloud-link">동묘</a>
                <a class="tag-cloud-link">ddp</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="백향목.jsp">백향목<span class="ion-ios-arrow-forward"></span></a></li>
                <li><a href="유네스코.jsp">유네스코<span class="ion-ios-arrow-forward"></span></a></li>
                <li class="active"><a href="Makesense.jsp">Makesense<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
