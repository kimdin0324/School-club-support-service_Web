...
<!-- ######################################################### -->
    <span>유네스코 <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                       청주신흥고등학교 유네스코 동아리는 유네스코 학교로 지정된 본교가 유네스코의 이념을 학교현장에서 실천하여 학생들과 지역사회 구성원들에게 지속가능한 성장을 위해 인류가 나아가야할길을 함께 공유하고 확산하는 역활을 수행합니다.<br>
                        <br>
                        누리고 팀: 세계 기아문제의 심각성고 해결방안 연구 및 홍보, 해결을 위한 실천방안 추진<br>
                        <br>
                        모래알바위돌 팀: 인종차별,난민문제,여성혐오,종교혐오 등 주류세계에서 소외된 소수자나 낯선 사람들에 대한 차별의식과 제도를 개선하기 위한 활동<br>
                        <br>
                        더불어숲 팀: 지역의 소외된 분들을 위한 봉사활동 활성화 방안 연구  <br><br>         
            <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                           10명<br></p>
           <p>------------------------------------------------------</p>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/총회.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>UN모의총회 </a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 2020년 중 </a></div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/공정.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>제 2회 공정무역 캠페인</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 2020년 중</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/모자.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>신생아 모자뜨기</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span>  2020년 중</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/봉사.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>제 2회 청주시 봉사 자료집 발간</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 2020년 중</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">UN</a>
                 <a class="tag-cloud-link">공정무역</a>
                <a class="tag-cloud-link">유네스코</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
               <li class><a href="백향목.jsp">백향목<span class="ion-ios-arrow-forward"></span></a></li>
                <li class="active"><a href="유네스코.jsp">유네스코<span class="ion-ios-arrow-forward"></span></a></li>
                <li class><a href="Makesense.jsp">Makesense<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
