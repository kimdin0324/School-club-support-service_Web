        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          ...
          <%--##########################################################################################--%>
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">메인 <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.jsp">동아리 살펴보기 <i class="ion-ios-arrow-forward"></i></a></span> 
                                   <span>음악 동아리<i class="ion-ios-arrow-forward"></i></span></p>
         <%--##########################################################################################--%>
         <%--##########################################################################################--%>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <%--##########################################################################################--%>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="RAIN.jsp">Rain</a></h3>
          		</div>
              <a href="RAIN.jsp" class="block-20" style="background-image: url('images/RAIN.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>어쿠스틱을 기반으로 한 분위기의 곡을 맞춰 공연하는 밴드부입니다.</p>
                <p><a href="RAIN.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="Naked.jsp">Naked lamb</a></h3>
          		</div>
              <a href="Naked.jsp" class="block-20" style="background-image: url('images/Naked lamb.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>힙합과 RnB 위주의 흑인음악을 주로 다루는 음악 동아리입니다.</p>
                <p><a href="Naked.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
          		<div class="text px-4 py-4">
          			<h3 class="heading mb-0"><a href="복4중창.jsp">복4중창단</a></h3>
          		</div>
              <a href="복4중창.jsp" class="block-20" style="background-image: url('images/복4중창단.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
                <p>신흥고등학교의 남성 복4 중창단입니다<br><br></p>
                <p><a href="복4중창.jsp" class="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
