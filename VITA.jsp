...
<!-- ######################################################### -->
    <span>VITA <i class="ion-ios-arrow-forward"></i></span></p>
<!-- ######################################################### -->
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">동아리 소개</h2>
                       보건의료에 관시있는 학생들이 모여, 의료와 관련된 주제에 대해<br>
                        토론하거나 책을 읽는등 함께 관련된 분야를 탐구하고 지식을 키워나가기 위한 동아리입니다.
                         <br><br>
                         <p>------------------------------------------------------</p>
            <p><b>></b> <b>인원</b><br>
                                            5명<br></p>
           <p>------------------------------------------------------</p>
            ...
            <p>------------------------------------------------------</p>       
            <p><b>></b> <b>활동계획</b><br>
                  1. 실생활 속 동아리 공통주제탐구----(07월)<br>
                  2. 개별 주제 탐구---------------(08월)<br>
                  3. 학술 발표------------------(09월)<br>
                  4. 실생활 속 동아리 공통주제 탐구---(10월)<br>
                  5. 개별주제 탐구---------------(11월)<br>
                  6. 탐구 정리 및 학술발표회--------(12월) <br>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/단체.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>공통주제탐구 </a></h3>
                  <div class="meta">
             ...
             <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/개인2.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>개별 주제 탐구</a></h3>
                  <div class="meta">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/학습.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a>학술발표회</a></h3>
                  <div class="meta">
                    <div><a><span class="icon-calendar"></span> 12월</a></div>
                    <div><a><span class="icon-chat"></span> 활동</a></div>
                  </div>
                </div>
              </div>
           ...
           <div class="sidebar-box ftco-animate">
              ...
              <div class="tagcloud">
                <a class="tag-cloud-link">보건</a>
                 <a class="tag-cloud-link">의료</a>
              </div>
            </div>
             ...
             <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li class="active"><a href="VITA.jsp">VITA<span class="ion-ios-arrow-forward"></span></a></li>
              </div>
            </div>
